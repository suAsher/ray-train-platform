...
2026-09-14 功能仓同步已发布并完成正式私有验收仓的手动按钮、真实权重下载校验和“运行中配置→训练成功→自动上传”验收。当前后端 Helm233/schema53，Portal dev `77d266b7`（CI33944成功）；用户入口固定正式功能仓，平台使用说明已更新。验收、源代码版本及长期授权等边界见[功能仓发布记录](FUNCTION_WAREHOUSE_INTEGRATION_PLAN_20260914.md#15-实际发布与用户入口收敛)。
