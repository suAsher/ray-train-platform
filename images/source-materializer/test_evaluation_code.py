...
spec = importlib.util.spec_from_file_location('evaluation_code', Path(__file__).with_name('platform-fetch-evaluation-code.py'))
...
class EvaluationCodeTest(unittest.TestCase):
    def setUp(self):
        ...
        self.output=self.root/'evaluation.zip'
    ...
    def test_download_is_exact_scoped_and_publishes_only_verified_bytes(self):
        ...
        self.assertEqual(request.full_url,BASE+'/jobs/'+JOB+'/model-evaluation/code')
