...
grep -Fq 'COPY examples/bevfusion/patches/apply-platform-runtime.py /usr/local/bin/apply-raytrain-bevfusion-runtime' "$dockerfile"
grep -Fq 'COPY examples/bevfusion/patches/ray_data_s1h_integration.py /usr/local/lib/raytrain-platform/bevfusion/ray_data_s1h_integration.py' "$dockerfile"
grep -Fq 'COPY examples/bevfusion/patches/raytrain_bevfusion_worker.py /usr/local/lib/raytrain-platform/bevfusion/raytrain_bevfusion_worker.py' "$dockerfile"
