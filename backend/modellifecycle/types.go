...
type Actor struct { ID string; Name string }
type Model struct {
...
type Filter struct { Q string; OwnerID string; Archived bool; Cursor string; Limit int }
type ModelUpdate struct { Name *string; Description *string; Archived *bool; Revision int64 }
type VersionUpdate struct { Description string; Revision int64 }
type ModelPage struct { Items []Model `json:"items"`; NextCursor string `json:"nextCursor,omitempty"` }
type VersionPage struct { Items []Version `json:"items"`; NextCursor string `json:"nextCursor,omitempty"` }
