...
type InitInput struct { Name string `json:"name"`; SizeBytes int64 `json:"sizeBytes"`; SHA256 string `json:"sha256"` }
type Part struct { Index int `json:"index"`; SizeBytes int64 `json:"sizeBytes"`; SHA256 string `json:"sha256"` }
...
type Record struct { Artifact; Scope Scope; IdempotencyHash string }
type Page struct { Items []Artifact `json:"items"`; NextCursor string `json:"nextCursor,omitempty"` }
...
type Service struct { repo Repository; objects Objects }
