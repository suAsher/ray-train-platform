...
func main(){
 ...
 if err!=nil{result=registryauth.AssembleResult{ErrorCode:"OCI_ASSEMBLY_FAILED"}}
 data,_:=json.Marshal(result)
 if writeErr:=os.WriteFile(resultPath,data,0600);writeErr!=nil{os.Stderr.WriteString("ASSEMBLY_RESULT_WRITE_FAILED\n");os.Exit(1)}
