...
func(r *GormRepository)FinalizeEnvironmentBuild(ctx context.Context,b eb.Build,leaseOwner string)error{
 return r.db.WithContext(ctx).Transaction(func(tx *gorm.DB)error{
  ...
  if current.LeaseOwner!=leaseOwner||current.Status!=eb.VerifyingPull{return eb.ErrConflict}
  ...
  if err:=image.Validate();err!=nil{return err}
  ...
  b.LeaseOwner="";b.LeaseUntil=nil;b.UpdatedAt=now;b.CleanedAt=nil
