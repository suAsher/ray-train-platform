...
func TestProductionSourceArtifactsRequireExplicitRayAPISpoolDir(t *testing.T) {
	...
	cfg := Config{AppEnv: "production", SourceArtifactsEnabled: true, TOSEndpoint: "https://tos-cn-beijing.volces.com", TOSRegion: "cn-beijing", TOSBucket: "private-bucket", TOSAccessKey: "test-ak", TOSSecretKey: "test-sk", SourceArtifactMaxPending: 1, SourceArtifactQuotaBytes: 2 * 1024 * 1024 * 1024}
