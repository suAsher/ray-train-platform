...
func (b Build) Target() string { return RegistryHost + "/" + b.Project + "/" + b.Repository + ":" + b.Tag }
func (b Build) Terminal() bool { return b.Status == Ready || b.Status == Canceled || b.Status == Failed || b.Status == AwaitingAuth }
