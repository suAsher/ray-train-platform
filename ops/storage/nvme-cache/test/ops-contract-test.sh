...
require_in "${ops_dir}/preflight.sh" 'platform.wellspiking.ai/gpu-pool=production'
...
reject_in "${ops_dir}/register-node.sh" '172.28.1.232'
reject_in "${ops_dir}/register-node.sh" '172.28.1.233'
require_in "${ops_dir}/register-node.sh" '.spec.unschedulable == true'
require_in "${ops_dir}/register-node.sh" 'platform.wellspiking.ai/gpu-pool'
