...
assert_contracts() {
  ...
  require_literal images/bevfusion-runtime/Dockerfile 'opencv-python==4.10.0.84'
  require_absent_literal images/bevfusion-runtime/Dockerfile 'opencv-python-headless'
  require_literal images/bevfusion-runtime/Dockerfile 'mmdet3d.ops.ball_query.ball_query_ext'
  require_literal images/bevfusion-runtime/Dockerfile 'mmdet3d.ops.furthest_point_sample.furthest_point_sample_ext'
  require_literal images/bevfusion-runtime/Dockerfile 'mmdet3d.ops.gather_points.gather_points_ext'
  require_literal images/bevfusion-runtime/Dockerfile 'mmdet3d.ops.group_points.group_points_ext'
  require_literal images/bevfusion-runtime/Dockerfile 'mmdet3d.ops.interpolate.interpolate_ext'
  require_literal images/bevfusion-runtime/Dockerfile 'mmdet3d.ops.knn.knn_ext'
